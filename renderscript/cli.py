...
from .project import package_project_file
...
def build_parser() -> argparse.ArgumentParser:
    ...
    project_parser.add_argument("--provider", type=str, default="universal")
    project_parser.add_argument("--add-pack", dest="include_provider_prompts", action="append", default=[])
    project_parser.add_argument("--provider-version", type=str, default="")
    project_parser.add_argument("--duration-s", type=int, default=3)
    project_parser.add_argument("--project", type=str, default="project")
    project_parser.add_argument("--batch-size", type=int, default=8)
    project_parser.add_argument("-o", "--output", type=Path, required=True)
