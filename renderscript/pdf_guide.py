...
def _render_html(
    ...
    return template.render(
        ...
        keeper_sheet_path="KEEPER_SHEET.csv",
...
def _fallback_pages(
    ...
    return [
        [
            ...
            *example_lines,
            "Open: DEVELOPER_FILES/package_map.md",
        ...
        [
            "Page 2: Refs",
            "Open: refs/",
            "Open: DEVELOPER_FILES/rpack.json",
            "Open: DEVELOPER_FILES/bindings.csv",
        ...
        [
            ...
            "Open: DEVELOPER_FILES/shot_list.csv",
            "Open: RENDERPACKAGE.pdf",
            "Open: <source>.fountain",
            "Keep audio notes outside the standard package unless a separate workflow adds them.",
        ],
        [
            "Page 5: Keepers + Iterate",
            "Open: KEEPER_SHEET.csv",
            "Open: DEVELOPER_FILES/keeper_decisions.csv",
            "Open: generated_shots/keepers/",
